...
local _地图 = { 1177, 1186, 1199, 1198, 1201, 1217, 1194, 1193, 1478, 1070, 1091, 1110, 1092, 1174 }
-- 龙窟一层, 凤巢一层, 御马监, 瑶池, 蟠桃园, 蟠桃园后, 五指山, 长安城东, 大唐边境, 长寿村, 长寿村外, 大唐境内, 傲来国, 北俱芦洲
    ...
    if r then
        ...
        for i = 1, 5 + math.floor(r.次数 * 0.4) do
            ...
            for _ = 1, math.random(3) do
                table.insert(怪物属性.技能, { 名称 = _怪物技能[math.random(#_怪物技能)], 熟练度 = 熟练 })
            end
