...
local _地图 = { 101349, 1174, 1177, 1178, 1179, 1186, 1187, 1188 }  -- 1194, , 五指山
-- 灵兽村, 北惧芦洲, 龙窟一层, 龙窟二层, 龙窟三层, 凤巢一层, 凤巢二层, 凤巢三层
...
function 任务:掉落包(玩家)
    ...
    local 经验 = 607548 * (1 + 玩家.其它.修罗次数 * 0.072) * 3
...
local _数量表 = { 5, 6, 7, 7, 7, 7, 7, 7, 7, 7 }
