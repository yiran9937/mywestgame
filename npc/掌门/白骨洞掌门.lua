...
local _smjn = { '幽冥鬼火', '火影迷踪', '冥烟销骨', '落日熔金', '血海深仇' }
local _消耗 = {
    2000,
    6000,
    12500,
...
function NPC:NPC菜单(玩家, i)
    ...
    elseif i == "5" then
        ...
        if r and r.快捷消耗 then
            local rr = 玩家:选择窗口2("确定花费#R" .. r.快捷消耗 .. "师贡完成任务么？\nmenu\n1|我要快点完成\n2|我再想想"
                , self.外形)
            if rr == "1" then
...
function NPC:领取师门任务(玩家, jn, 序号)
    ...
    local r = 生成任务 { 名称 = '日常_师门任务', 分类 = 分类, 技能 = jn, 序号 = 序号, 门派 = 'bg' }
...
function NPC:NPC给予(玩家, cash, items)
    local r = 玩家:取任务('日常_师门任务')
    if r and r.门派 == 'bg' and items[1] then --
