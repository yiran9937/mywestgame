...
local list = {
    ...
    { 类别 = "道具", 名称 = "霄汉鼎", 属性 = "#Y抗风+3", 参数 = 3, 价格 = 500 },
    { 类别 = "道具", 名称 = "沧海珠", 属性 = "#Y抗水+3", 参数 = 3, 价格 = 500 },
    { 类别 = "道具", 名称 = "蓝田玉", 属性 = "#Y抗雷+3", 参数 = 3, 价格 = 500 },
    { 类别 = "道具", 名称 = "烈焰砂", 属性 = "#Y抗火+3", 参数 = 3, 价格 = 500 },
    { 类别 = "道具", 名称 = "灵犀角", 属性 = "#Y抗混乱+3", 参数 = 3, 价格 = 500 },
    { 类别 = "道具", 名称 = "五溪散", 属性 = "#Y抗昏睡+3", 参数 = 3, 价格 = 500 },
    { 类别 = "道具", 名称 = "雪蟾蜍", 属性 = "#Y抗中毒+3", 参数 = 3, 价格 = 500 },
    { 类别 = "道具", 名称 = "云罗帐", 属性 = "#Y抗封印+3", 参数 = 3, 价格 = 500 },
    { 类别 = "道具", 名称 = "武帝袍", 属性 = "#Y物理吸收+3", 参数 = 3, 价格 = 500 },
    { 类别 = "道具", 名称 = "盘古石", 属性 = "#Y抗仙法+0.5", 参数 = 3, 价格 = 500 },
    { 类别 = "普通装备", 名称 = "布鞋", 价格 = 500 },
    { 类别 = "普通装备", 名称 = "佛珠", 价格 = 500 },
    { 类别 = "道具", 名称 = "金柳露", 价格 = 5000 },
    { 类别 = "普通装备", 名称 = "夜明珠", 价格 = 2000 },
    { 类别 = "道具", 名称 = "卧龙丹", 价格 = 2000 },
    { 类别 = "道具", 名称 = "龙凤石", 价格 = 5000 },
