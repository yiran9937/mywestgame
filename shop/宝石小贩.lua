...
-- @Date                : 2024-10-31 21:40:32
-- @Last Modified time  : 2024-11-03 11:13:06

local 商店 = {}

local list = {
    { 类别 = "道具", 名称 = "宝石精华", 参数 = 4 , 属性 = "打开获得一级随机宝石", 价格 = 2500000 },
    { 类别 = "道具", 名称 = "随机新宝石", 参数 = 4 , 属性 = "打开获得四级随机宝石",价格 = 2500000 },
    { 类别 = "道具", 名称 = "随机新宝石", 参数 = 7 , 属性 = "打开获得七级随机宝石", 价格 = 25000000 },
