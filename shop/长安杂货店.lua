...
local list = {
    ...
    -- { 类别 = "道具", 名称 = "200环令", 价格 = 100000 },
    { 类别 = "道具", 名称 = "高级宠物口粮", 价格 = 1000 },
    { 类别 = "道具", 名称 = "百里香", 价格 = 500 },
    { 类别 = "道具", 名称 = "摄妖香", 价格 = 1000 },
    { 类别 = "道具", 名称 = "杀人香", 价格 = 10000000 },
    { 类别 = "道具", 名称 = "追杀令", 价格 = 30000000 },
    { 类别 = "道具", 名称 = "还原丹", 价格 = 1000 },
    { 类别 = "道具", 名称 = "还我漂漂丹", 价格 = 1000 },
    { 类别 = "道具", 名称 = "枯荣丹", 价格 = 1000 },
    { 类别 = "道具", 名称 = "疏筋理气丸", 价格 = 100000 },
    { 类别 = "道具", 名称 = "六脉化神丸", 价格 = 500000 },
    { 类别 = "道具", 名称 = "玉枢返虚丸", 价格 = 3000000 },
    --{ 类别 = "道具", 名称 = "八荒遗风", 参数 = 1, 价格 = 8000000 },
}
